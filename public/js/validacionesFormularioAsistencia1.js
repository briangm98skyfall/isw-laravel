document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("formUpdateAsistencia").addEventListener('submit', validarFormularioUpdateAsistencia);
});

function validarFormularioUpdateAsistencia(evento) {

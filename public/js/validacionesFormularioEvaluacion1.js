document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("formUpdateEvaluacion").addEventListener('submit', validarFormularioUpdateEvaluacion);
});

function validarFormularioUpdateEvaluacion(evento) {

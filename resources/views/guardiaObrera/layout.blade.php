                ...
                <div class="full-box nav-lateral-content">
                    <figure class="full-box nav-lateral-avatar">
                        ...
                        <figcaption class="roboto-medium text-center">
                            Vicedecano de Administración <br><small class="roboto-condensed-light"></small>
                        </figcaption>
                    </figure>
                    ...
                    <nav class="full-box nav-lateral-menu">
                        <ul>
                            ...
                            <li>
                                <a href="#" class="nav-btn-submenu"><i class="fas fa-users fa-fw"></i> &nbsp; Guardia Obrera<i class="fas fa-chevron-down"></i></a>
                                <ul>
                                    <li>
                                    ...
                                    @section('listar')
                                    <li>
                                        <a href="client-list.html"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Listar Guardia Obrera</a>
                                    </li>
                                    @endsection
                            ...
                            <li>
                                <a href="company.html"><i class="fas fa-store-alt fa-fw"></i> &nbsp; Cumplimiento de Guardia Obrera</a>
                            </li>
                        </ul>
                    </nav>
                </div>
